  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 p-3 bg-terminal-bg border border-terminal-border rounded-lg shadow-terminal transition-all duration-300 hover:border-terminal-green hover:shadow-terminal ${
